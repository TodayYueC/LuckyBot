...
function layout() {
  ...
  $("#app").innerHTML =
    `<div class="studio"><aside class="sidebar"><div class="brand">LuckyBot<span style="color:#8caec4">.</span></div><div class="subtitle">群友工作室<br>CONVERSATION STUDIO</div><nav>${Object.entries(
      pages,
    )
      .map(
        ([k, v]) =>
