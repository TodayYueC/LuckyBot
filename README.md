...
**一个人就是一个人。** 同一个 QQ 号在所有群和私聊里是同一个人。记忆只有一份。别处知道的事只在相关时想起，而且是同一个人自己的话对上，不能把两个人的词拼在一起。私下知道的不当众说，发出去之前也会对一次。被要求保密的不离开原来的地方，发出去之前还会再对一次。别人插话，或这个人自己又说了几句，都不会把这次的保密冲掉。整理出的事实、安排和阶段摘要，句尾那个词必须来自原话。没留下的、已经撤销的，不写进这段记录。句尾仍是原话时，前面换掉的词仍可能留下来。换一种说法，发出去之前仍可能对不上。
