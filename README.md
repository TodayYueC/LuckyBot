...
其余的部分不是设定表。自我线索（喜欢、看法、特质、习惯、放在心上的事）要在不同的日子里反复出现才成形。TA 在每个群有自己的面貌。对每个人有熟悉、亲近、信任和别扭。手记、日记、读过的段落、别人的反馈，都可以成为下一次变化的来源。撤销留下墓碑，后来的整理不会把它写回来，也不会再写进那段经历的记录。

## 一天怎么过

短时间内的连续消息合成一批。明确的「记住，我……」当场成为记忆（凭据除外）。这段还没整理完之前，若这个人刚要求过保密，这句也按秘密记；整理过之后，旧的保密请求不再套到下一次。然后 TA 决定要不要认真看。
...
**由心开口。** 没有参与概率，没有冷却，也没有「被 @ 就一定回」的捷径。细看的时候只调用一次模型，同时得到：这段话对 TA 意味着什么、感受、对人的变化、选择和要说的话。选择是开口、短短反应、说不想聊，或不出声。沉默不是空白：心情和对人的感觉照样变，理由写进记录。这件事对 TA 意味着什么会留下来；下次同一人在场，只回到 TA 自己心里，不当场复述。安静下来或写日记时，这些意思可以成为变化的来源；撤销之后就不再算数。群里别人的说话节奏听得见，不会写成 TA 自己的样子；TA 不在时路过的话，也不变成这个地方的样子。决定开口但话没有发出去，不算说上话，也不刷新上次说上话。前面的话已经送出、后面失败，仍算说上了。含私下相遇、私聊或只在私下说得清的心情的那一天，日记摘要不进别的房间。被要求保密的那句话如果写进日记、手记、样子或印象，别的房间也看不到。这一批里有人要求保密时，这次相遇的理解，以及由此留下的印象，也留在原来的会话。手记就算同时引用了别的地方，也不会把这件事带过去。保密的安排会让这一天的日记不进别的房间和后来的回顾；说出这件事的房间里，日记还在。别人的话若真的碰到 TA 正在为自己而活的事，次数和上次出没出声是事实，不是任务。这件事换了说法之后，对不上现在这句话的旧次数不再算。同一批里还有别人时，不把那次开口算成对这个人出了声，除非她回的就是这个人的话。后来在只属于这个人的私聊里自己开口，也记成出了声，这句不进别的房间。
...
**一个人就是一个人。** 同一个 QQ 号在所有群和私聊里是同一个人。记忆只有一份。别处知道的事只在相关时想起，而且是同一个人自己的话对上，不能把两个人的词拼在一起。私下知道的不当众说，发出去之前也会对一次。被要求保密的不离开原来的地方，发出去之前还会再对一次。别人插话，或这个人自己又说了几句，都不会把这次的保密冲掉。整理出的事实、安排和阶段摘要，句尾那个词必须来自原话。压缩摘要里以后还用得上的要点也一样。没留下的、已经撤销的，不写进这段记录。句尾仍是原话时，前面换掉的词仍可能留下来。换一种说法，发出去之前仍可能对不上。

**TA 的日子从醒来算起。** 睡着时不看群。被私聊或 @ 会等醒来再看，危机会把 TA 叫醒。睡前一小时犯困，刚醒一小时迷糊。两小时里说得越多越累。聊天安静一阵、又积累了新的经历时，TA 会独处：一次看完各个会话的近况，留下新的理解，修正自我、面貌和对人的印象。会话关掉时路过的话不是经历：不留未读，不进独处、日记、夜里的记忆、重新打开后的细看和压缩摘要，不改心情和关系，不算当时在场，也不算这一天见过的人，不把那时才出现的称呼套到后来的话上。重新打开后，这些话也不算还在聊天。关掉的私聊不会把公开的这一天关在外面。扫过但还没细看的，独处时仍然可以读到。书架上共享的资料，TA 会按兴趣一段一段读，读后的想法可以长成自己的一部分，聊天时自然提起。私聊范围的资料不会被读进心里。
...
人也会变淡。超过一段时间没来往，亲近和熟悉慢慢回落；久别后的第一次来往会热回来一半。心里记下的印象不算来往。私下形成的印象、别扭的原因、自我线索和心情的原因，只留在那次私聊。TA 分得清「好久不见」和「最近没怎么说上话」。人还在眼前、只是好久没说上话时，独处里也能看见，不和好久不见混在一起。扫一眼群聊也算见到。天天在群里出现、只是没和 TA 说话的人，不会被当成久别。别人叫 TA、TA 没出声，也不算说上话。话没有发出去，同样不算。
