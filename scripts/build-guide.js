...
const html = `<!doctype html><html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>LuckyBot v0.5.1 · 使用教程</title><style>
...
</style></head><body><header><div><b>LuckyBot · 上手手册</b><small>YOUR CHAT COMPANION / v0.5.1</small></div><nav><a href="/#setup">返回管理台</a><a href="/tutorial.md" download>下载 Markdown</a><button onclick="window.print()">打印 / 保存 PDF</button></nav></header><div class="layout"><nav class="toc" aria-label="教程目录"><p>CONTENTS</p>${headings.map((h) => `<a href="#${h.id}">${h.label}</a>`).join("")}</nav><article>${article}</article></div><footer>LuckyBot · 从本机试聊，到慢慢熟悉一个群。教程与 v0.5.1 界面同步。</footer></body></html>`;
