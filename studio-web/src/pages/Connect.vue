...
<template>
  <div class="connection-workbench">
    <section class="connection-setup surface" v-if="setup" :aria-busy="busy">
      <div class="card-head">
        <h2>QQ 接入助手</h2>
        <span class="pill">{{
        ...
        <article>
          ...
          <div>
            ...
            <div class="qq-path">
              ...
              />
              <button type="button" id="pickNapcat" @click="run(pick)">
                选择目录
              </button>
            </div>
            <div class="row">
    ...
    <section class="connection-checklist surface">
      <h2>还差哪一步</h2>
      <article
