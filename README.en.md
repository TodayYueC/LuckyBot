...
For everyday use, download the [latest Release](https://github.com/TodayYueC/lucky-qq-ai-friend/releases/latest) (currently v0.5.0). The default `main` branch is the development trunk and may include changes that have not been tagged yet. To run this official version, check out `v0.5.0` after cloning. To follow latest development, skip that step.
